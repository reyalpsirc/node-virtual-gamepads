...
(function() {
  var config, fs, ioctl, uinput, uinputStructs, virtual_gamepad_extended, winston;
  ...
  virtual_gamepad_extended = (function() {
    function virtual_gamepad_extended() {}

    virtual_gamepad_extended.prototype.connect = function(callback, error, retry) {
      if (retry == null) {
        retry = 0;
      }
    ...
    virtual_gamepad_extended.prototype.disconnect = function(callback) {
      if (this.fd) {
    ...
    virtual_gamepad_extended.prototype.sendEvent = function(event, error) {
    ...
    return virtual_gamepad_extended;
